# Overview
We are modifying https://github.com/tbcstar/mod-high-risk-system/blob/master/src/high_risk_system.cpp
to facilitate dropping chests on all forms of death
...
```
## Requirements
1. Using the high risk system inline as a code create a lightweight c++ module for azerothcore
2. Reference mod-individual-progression to understand the file requirements of an azerothcore module
3. Inline the C++ code with adequate comments. We prefer shorter more semantic functions
4. Maintain the correct copyright attribution as the inline code for all files
5. Create an attribute file that correctly attributes the necessary team as based in the comment and links to https://github.com/tbcstar/mod-high-risk-system
